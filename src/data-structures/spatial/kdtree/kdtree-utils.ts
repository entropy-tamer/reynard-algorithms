 ...
 * @example
 */
export function calculateTreeStats(root: KdNode | null, config: Required<KdTreeConfig>, stats: KdTreeStats): void {
  if (!root) {
    stats.totalPoints = 0;
    stats.nodeCount = 0;
    stats.height = 0;
 ...
 * @example
 */
export function emitEvent(eventHandlers: KdTreeEventHandler[], type: KdTreeEventType, data: any): void {
