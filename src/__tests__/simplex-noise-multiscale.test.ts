/**
 * @file Tests for Simplex noise multiscale algorithms
 */

import { describe, expect, it } from "vitest";
import { SimplexNoise } from "../algorithms/procedural-generation/simplex-noise/simplex-noise-core";
import type { MultiscaleSimplexNoiseOptions } from "../algorithms/procedural-generation/simplex-noise/simplex-noise-types";

describe("Simplex Noise Multiscale", () => {
  describe("generateMultiscaleNoise2D", () => {
    it("should generate multiscale noise with multiple scales", () => {
      ...
      const options: MultiscaleSimplexNoiseOptions = {
        scales: [
  ...
  describe("generateMultiscaleNoise4D", () => {
    it("should generate multiscale 4D noise", () => {
      const noise = new SimplexNoise({ seed: 12345 });
      const options: MultiscaleSimplexNoiseOptions = {
        scales: [
          { frequency: 0.01, amplitude: 1.0 },
      ...
      const result = noise.multiscaleNoise4D(10, 20, 30, 40, options);
  ...
  describe("SimplexNoise class multiscale methods", () => {
    ...
    it("should respect config frequency", () => {
      ...
      const result2 = noise.multiscaleNoise2D(20, 40, options);
