...
describe('A* Pathfinding Algorithm', () => {
  ...
  beforeEach(() => {
    ...
    simpleGrid = {
      ...
      height: 5,
      cellSize: 1,
      cells: Array(5).fill(null).map(() => Array(5).fill(true)),
    };
    ...
    complexGrid = {
      ...
      height: 10,
      cellSize: 1,
      cells: Array(10).fill(null).map(() => Array(10).fill(true)),
    };
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle very large grids efficiently', () => {
      const largeGrid: AStarGrid = {
        ...
        height: 100,
        cellSize: 1,
        cells: Array(100).fill(null).map(() => Array(100).fill(true)),
      };
    ...
    it('should work with different grid configurations', () => {
      const grids = [
        ...
        complexGrid,
        {
          ...
          height: 3,
          cellSize: 1,
          cells: Array(3).fill(null).map(() => Array(3).fill(true)),
        },
      ];
