...
import { Quadtree, Rectangle, QuadtreeEvent } from "../../data-structures/spatial/quadtree";
describe("Quadtree", () => {
  ...
  // Performance benchmarks moved to quadtree.performance.test.ts
  // to keep unit pipeline strict and fast.
