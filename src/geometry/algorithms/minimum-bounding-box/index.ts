/**
 * @module algorithms/geometry/algorithms/minimum-bounding-box
 * @description Minimum Bounding Box with rotating calipers algorithm.
 */

export { MinimumBoundingBox } from "./minimum-bounding-box-core";
export { MinimumBoundingBoxUtils } from "./minimum-bounding-box-utils";
export type {
  Point,
  Vector,
  Rectangle,
