/**
 * @file Wave Function Collapse Algorithm Index
 *
 * @module algorithms/geometry/algorithms/wave-function-collapse
 * @description Provides the Wave Function Collapse algorithm for constraint-based procedural generation.
 */

export { WaveFunctionCollapse } from "./wave-function-collapse-core";
export type {
  Position2D,
  Position3D,
  Tile,
