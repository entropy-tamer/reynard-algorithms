...
import type { ConvexPolygon, ProjectionAxis, Point2D, SATConfig } from "./sat-types";
 ...
 * @example
 */
export function findEdgeContactPoints(polygon1: ConvexPolygon, polygon2: ConvexPolygon, config: SATConfig): Point2D[] {
  const contactPoints: Point2D[] = [];
 ...
 * @example
 */
function getClosestPointOnLineSegment(point: Point2D, lineStart: Point2D, lineEnd: Point2D): Point2D {
