...
export const euclideanDistance: AStarHeuristic = (() => {
  const memo = adaptiveMemo(
    ...
    { name: "euclideanDistance", maxSize: 4096, minHitRate: 0.6, windowSize: 500, minSamples: 200 },
 ...
 * @example
 */
export const zeroHeuristic: AStarHeuristic = (_from: Point, _to: Point): number => {
  return 0;
};
 ...
 * @example
 */
export const multiObjectiveHeuristic = (heuristics: AStarHeuristic[], weights: number[]): AStarHeuristic => {
