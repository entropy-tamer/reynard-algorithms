...
import type { Point, ThetaStarOptions } from "./theta-star-types";
 ...
 * @param weights.smoothness
 * @param weights.safety
...
export function calculateMultiObjectiveHeuristic(
  ...
  return weights.distance * distanceHeuristic + weights.smoothness * smoothnessFactor + weights.safety * safetyFactor;
}
 ...
 * @example
 */
export function calculateAdmissibleHeuristic(from: Point, to: Point, options: ThetaStarOptions): number {
 ...
 * @example
 */
export function calculateConsistentHeuristic(from: Point, to: Point, options: ThetaStarOptions): number {
 ...
 * @param goalBounds.min
 * @param goalBounds.max
