...
export function rayIntersection(
  ...
  (stats as any).averageQueryTime = ((stats as any).averageQueryTime * (stats.rayIntersections - 1) + executionTime) / stats.rayIntersections;
...
export function aabbIntersection(
  ...
  (stats as any).averageQueryTime = ((stats as any).averageQueryTime * (stats.aabbIntersections - 1) + executionTime) / stats.aabbIntersections;
